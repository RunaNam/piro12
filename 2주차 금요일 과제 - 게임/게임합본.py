...
while u.mental > 0 and end == False:
    ...
    print()
    time.sleep(1.5)
    print("맛있는 점심을 먹고 이제 후식 타임~! 다같이 커피 내기를 시작해볼까요?")
    time.sleep(1.5)
    print("카페 갈까?")
    time.sleep(1.5)
    print("좋지 좋지 모먹지,, 난 아메리카노^---^")
    time.sleep(1.5)
    print("난 에이드!!!!")
    time.sleep(1.5)
    print("나 결정 못하는데...")
    print("모야...카페 줄이 길군... 우리 커피 종류를 통일하자.")
    time.sleep(1.5)
    print()
    ...
    time.sleep(1.5)
    print()
    print("미쳤네... 커피 값 봐..2000원이 아니라 20000원이야?")
    time.sleep(1.5)
    print("맞네 내 눈이 이상한줄 알았어...")
    time.sleep(1.5)
    print("어차피 내기 잖아 그냥 먹자!!")
    time.sleep(1.5)
    print("나는 절대 안걸리지~!!")
    time.sleep(1.5)
    print("그래 고고해 난 내기 중독 피로그래머니까,,,")
    print()
    time.sleep(1.5)
    print("카페직원: 주문하시겠어요? ")
    time.sleep(1.5)
    ...
    if menu in ["아메리카노", "1번", "1"]:
        ...
        time.sleep(1.5)
    print("")
    print("이제 누가 살지 정해볼까? 사다리 타기게임 어때?")
    time.sleep(1.5)
    print("좋지 고고!! ")
    time.sleep(1.5)
